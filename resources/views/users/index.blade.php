                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('users.show', $user->id) }}" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 hover:bg-blue-200">View</a>
                                            <a href="{{ route('users.edit', $user->id) }}" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-100 hover:bg-indigo-200">Edit</a>
